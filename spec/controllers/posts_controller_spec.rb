    ...
    describe 'PUT update' do
      ...
      describe 'with valid params' do
        it 'updates the requested post' do
          ...
          allow_any_instance_of(Post).to receive(:update).with(attributes)
          put :update, { id: user_post.to_param, post: attributes }
        end
    ...
    describe 'DELETE destroy' do
      ...
      context 'delete other user\'s post' do
        it 'redirects to the front page' do
          ...
          otherPost = create(:post, user: user2)
          delete :destroy, { id: otherPost.to_param }
          expect(response).to redirect_to(root_path)
